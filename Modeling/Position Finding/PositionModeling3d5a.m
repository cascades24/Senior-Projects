...
% variable inside function to apply an error)
    ...
    % calculate phase difference between antennas 1 and 3
    
    % These values are what we will be measuring 
    
    % These are the calculations we will be doing to find  
    theta12 = acosd(lambda*dphi12/(2*pi*s12)); % Elevation
    
    psi13 = atand(dphi13*s13/(dphi12*s12)); % Azimuth
    psi13_2= asind(dphi13*s13/(dphi12*s12)); 
    
    psi14 = asind(dphi14*s14/(dphi12*s12));
