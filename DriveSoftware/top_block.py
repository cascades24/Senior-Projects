...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rateL = samp_rateL = samp_rate/100
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 45*nfilts)
        self.carrier = carrier = 400e6
        self.baseband_LO = baseband_LO = 1e6
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\camil\\Desktop\\message_test.csv', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        (self.blocks_file_source_0).set_max_output_buffer(500000)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\camil\\Desktop\\readcsv.txt', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\camil\\Desktop\\output.txt', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_complex_to_imag_0 = blocks.complex_to_imag(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, -baseband_LO, 0.5, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, baseband_LO, 1, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_feedforward_agc_cc_0, 0), (self.digital_constellation_decoder_cb_0, 0))
        self.connect((self.analog_feedforward_agc_cc_0, 0), (self.qtgui_const_sink_x_0, 1))
        self.connect((self.analog_feedforward_agc_cc_0, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_complex_to_imag_0, 0), (self.qtgui_time_sink_x_1, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_samp_rateL(self.samp_rate/100)
    ...
    def get_samp_rateL(self):
        return self.samp_rateL

    def set_samp_rateL(self, samp_rateL):
        self.samp_rateL = samp_rateL
        self.qtgui_time_sink_x_1.set_samp_rate(self.samp_rateL)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rateL)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rateL, 8e3, 1.6E3, firdes.WIN_HAMMING, 6.76))
